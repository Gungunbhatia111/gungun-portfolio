  ...
  return (
    <footer className="py-12 border-t border-slate-800/80 light:border-slate-200 bg-slate-950/80 light:bg-slate-100 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="p-2 rounded-lg bg-slate-900 light:bg-slate-200 text-slate-400 hover:text-sky-400 transition-colors"
              title="GitHub"
            >
          ...
          <div className="flex items-center gap-4 text-xs text-slate-400">
            <span>
              Shri Ram Murti Smarak CET (SRMS CET), Bareilly
            </span>
            <button
              onClick={scrollToTop}
              className="p-2 rounded-lg bg-slate-900 light:bg-slate-200 text-slate-400 hover:text-sky-400 transition-colors"
        ...
        <div className="mt-8 pt-6 border-t border-slate-900 light:border-slate-200 text-center text-[11px] text-slate-400">
          Copyright {new Date().getFullYear()} Gungun Bhatia. All rights reserved. Designed & built with React, Node.js, Express & Tailwind CSS.
        </div>
      </div>
    </footer>
  );
